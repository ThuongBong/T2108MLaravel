...
@section('content-header')
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <a href="/admin/subjects-create"><button type="button" class="btn btn-primary float-right">Add Subject</button></a>
        </div>
    </div>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <form method="get" action="{{"/admin/subjects-list"}}">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <td><a href="/admin/subject-edit"><button type="button" class="btn btn-info">Edit</button></a></td>
